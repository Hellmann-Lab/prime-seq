---
title: "Low_input_Sensitivity"
output: html_notebook
---

Compare Sensitivity in 1k vs 10k cells
...
###5. HEK - Number of exonic umis and genes per sample per downsampling
```{r sensitivity_exon_HEK}
...
###6. Sensitivity and complexity at different seq depth
```{r}
...
```
###7. Biotypes of transcripts for 1k Cells and 10k Cells
...
###17. Final Sensitivity Figure -- Inex, Column and Beads
