...
abamfile<-c(paste0("/data/share/htp/prime-seq_Paper/Fig_gdna_priming/zUMIs/",project[1],"/Bulk_opt_gDNA_priming_",project[1],".filtered.tagged.Aligned.out.bam"),
           paste0("/data/share/htp/prime-seq_Paper/Fig_gdna_priming/zUMIs/",project[2],"/Bulk_opt_gDNA_priming_",project[2],".filtered.tagged.Aligned.out.bam"),
           paste0("/data/share/htp/prime-seq_Paper/Fig_gdna_priming/zUMIs/",project[3],"/Bulk_opt_gDNA_priming_",project[3],".filtered.tagged.Aligned.out.bam")
            )  
