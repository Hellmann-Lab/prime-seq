...
The ‘colapse\_downsampled\_counts()’ function iterates through the list
of different downsampling depth generated by zUMIs and extracts number
of Genes and number of UMIs
...
## we take the downsampled counts here to 
